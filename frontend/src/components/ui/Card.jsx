...
const Card = () => {
  ...
  const tl = useRef();
  const borderRef = useRef(); // ref for animated border
  ...
  const tasks = [
    { id: 1, label: "Software", left: "6%", width: "60%", top: 50, link: "https://github.com/tahazzee" },
    { id: 2, label: "Website", left: "35%", width: "60%", top: 120, link: "https://tahazzeeportfolio.netlify.app" },
    { id: 3, label: "Mobile app", left: "60%", width: "60%", top: 190, link: "https://www.linkedin.com/in/umme-tahazzee/" },
    { id: 4, label: "UX-UI", left: "35%", width: "60%", top: 260, link: "https://www.instagram.com/" },
  ];

  return (
    <div
      className="cardbg relative flex flex-col items-center md:w-[400px] p-6 border border-cyan-600
    ...
    >
      ...
      {/* Timeline Section */}
      <div
        className="cardbg relative w-full h-[300px] flex flex-col justify-between rounded-2xl overflow-hidden z-10"
        style={{
      ...
      <div className="w-full h-auto md:h-[300px] flex flex-col gap-4 text-left items-start mt-4 z-10">
